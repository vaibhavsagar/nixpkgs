...
self: super: {
  ...
  cryptonite = (if self.ghc.enableIntegerSimple then (pkgs.lib.flip disableCabalFlag "integer-gmp") else pkgs.lib.id) (appendPatch super.cryptonite (pkgs.fetchpatch {
